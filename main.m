function [ ] = main()
    ...
    objs = GroceryObject(3,workspace);
    
    target = objs.object{obj_target}.base

    q2_target = findQ(objs.object{obj_target}.base,robot2);
    ...
    for k1 = 1:100
        ...
        robot1.animate(q1);
        [q2,q2_target] = EV10Flowchart(q2,q2_target,robot2.base,objs,robot2);
        robot2.base = q2_base;
        robot2.animate(q2);
        if held(1)>0
